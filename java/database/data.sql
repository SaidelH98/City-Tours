...
INSERT INTO landmarks (name, city, country, venue_type, image, description, address) VALUES ('Trevi Fountain', 'Rome', 'Italy', 'Monument', 'https://images.unsplash.com/photo-1583422095309-55daabc9cc78?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=880&q=80', 'The Trevi Fountain is an 18th-century fountain in the Trevi district in Rome, Italy, designed by Italian architect Nicola Salvi and completed by Giuseppe Pannini in 1762 and several others.', 'Piazza di Trevi, 00187 Roma RM, Italy');
