...
public class RatingController {
    ...
    public void thumbsUpLandmarkByUser(@PathVariable int userId, @PathVariable int landmarkId, @RequestBody Rating rating) {
        ratingDao.thumbsUpLandmarkByUser(userId, landmarkId);
    }

    @ResponseStatus(HttpStatus.CREATED)
    @PostMapping("thumbsDown/{userId}/{landmarkId}")
    public void thumbsDownLandmarkByUser(@PathVariable int userId, @PathVariable int landmarkId,  @RequestBody Rating rating) {
